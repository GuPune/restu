...
class BuController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = SlideImage::where('slide_type','7')->get();


        return view('pages.logo/bu.logoslide')->with('data',$data);
    }
    ...
    {
        //
        return view('pages.logo/bu.create');
    }
    ...
    {
        //
        $data = SlideImage::where('slide_type','7')->where('id',$id)->first();


        return view('pages.logo/bu.edit')->with('data',$data);
    }

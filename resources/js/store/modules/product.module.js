...
context.commit(SET_DISCOUNT,payload);
    ...
    async [FETCH_ORDER_CUS_DRINK](context,payload) {
        const { data } = await ProductService.orderscus_drink(payload);
        return data;
    },
    ...
    async [SHOWTOE](context) {
        const { data } = await ProductService.showtoe();

        return data;
    },


    async [CHANGETOESUSS](context,payload) {

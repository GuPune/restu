        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div class="card-header py-3">
                    ตั้งค่าภาษา ข้อความใต้หัวเรื่อง
                </div>
                ...
                <div class="table-responsive pt-1">
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$k}}</td>
                                <td><input type="text" id="th{{$datas->id}}" value="{{$datas->title_th}}"></td>
                                <td><input type="text" id="en{{$datas->id}}" value="{{$datas->title_en}}"></td>
                                <td><input type="text" id="cn{{$datas->id}}" value="{{$datas->title_cn}}"></td>
                                <td>
...
function handle(event){
    ...
    $.ajaxSetup({
                ...
                $.ajax({
                    ...
                    data:{
                        '_token': "{{ csrf_token() }}",
                        title_th:th,title_en:en,title_cn:cn},
                    url: '/admin/title/'+ event.id,

        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div class="py-2"  style="text-align:right;padding:3px;">
                    <a href="{{ route('logobrand.create') }}" class="btn btn-success">
                       เพิ่มโลโก้แบรนด์
                    </a>
                </div>
              <div class="card-body">
                  ...
                  <table id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{ url('/admin/logobrand/' . $items->id . '/edit') }}" class="btnx editmdi btn-edit"><i class="mdi mdi-brush"></i></a>
